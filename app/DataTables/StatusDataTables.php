...
class StatusDataTables extends DataTable
{
    /**
        ...
        $dataTable = new EloquentDataTable($query);
         ...
         return $dataTable->addColumn('action', function($data) {
            return '<div class="btn-group">
                        <a href="'.url('datamaster/status').'/'.$data->id.'/edit" class="btn btn-sm btn-outline-info" data-toggle="tooltip" title="Ubah"><i class="zmdi zmdi-edit"></i></a>
