...
@section('content-penduduk')
    <div class="card">
        <div class="card-header"><h5 class="card-title">Wilayah Administrasi RW [ Gayam ]</h5></div>    
        <div class="card-block">
            <a href="{{ url('rw/create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
               ...
               <thead class="thead-default">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ url('rt') }}" class="btn btn-sm btn-outline-info"><i class="zmdi zmdi-view-list"></i> Rincian</a>
