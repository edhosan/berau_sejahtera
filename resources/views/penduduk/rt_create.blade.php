...
@section('content-penduduk')
	<div class="card">
		<div class="card-header"><h5 class="card-title">Entry Data Wilayah Administrasi RT</h5></div>		
		<div class="card-block">
		 	<form action="" method="post">
			     ...
			     <div class="form-group {{ $errors->has('guard_name') ? 'has-danger' : '' }}">
			         <label class="form-control-label">Nama Ketua RT</label>
			         <input type="text" name="guard_name" class="form-control {{ $errors->has('guard_name') ? 'form-control-danger' : '' }}" value="{{ old('guard_name') }}">
			         <i class="form-group__bar"></i>
			     </div>
			     ...
			     <div class="form-group">
			       ...
			       <a href="{{ url('rt') }}" class="btn btn-secondary waves-effect">Batal</a>
			     </div>
		   </form>			
		</div>
	</div>
