  ...
  <div class="card-block">
    <div class="tab-container">
      <ul class="nav nav-tabs" role="tablist">
           ...
           <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" href="{{ route('register') }}" role="tab">Form Pendaftaran User</a>
           </li>
       </ul>
             ...
             <div class="card-block">
               <form action="{{ route('register') }}" method="post">
                 ...
                 <div class="form-group {{ $errors->has('email') ? 'has-danger' : '' }}">
                     ...
                     <input type="email" name="email" class="form-control {{ $errors->has('email') ? 'form-control-danger' : '' }}" value="{{ old('email') }}">
                     <i class="form-group__bar"></i>
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <select class="select2" multiple data-placeholder="Select one or more choices" name="roles[]">
