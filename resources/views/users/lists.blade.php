  ...
  <div class="card-block">
    <div class="tab-container">
       <ul class="nav nav-tabs" role="tablist">
           <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" href="{{ route('users.index') }}" role="tab">Daftar User</a>
           </li>
       </ul>
       <div class="tab-content">
         <div class="tab-pane active fade show" role="tabpanel">
           <a href="{{ route('register') }}" class="btn btn-primary waves-effect">Tambah User</a>
           <div class="table-responsive">
             <table id="data-table-users" class="table table-bordered">
