...
@section('subtitle','Manajemen data master agama, pendidikan dalam kk, pendidikan sedang ditempuh, pekerjaan, hubungan keluarga')

@section('content')
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Daftar Hubungan Keluarga</h4>
	</div>
	<div class="card-block">
	   <a href="{{ route('hubungan.create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
	   <div class="table-responsive">
	     <table id="data-table-hubungan" class="table table-bordered">
...
var table = $('#data-table-hubungan').DataTable({
    autoWidth: false,
    responsive: true,
    lengthMenu: [[15, 30, 45, -1], ['15 Rows', '30 Rows', '45 Rows', 'Everything']],
    ajax: '{{ url("datamaster/hubungan") }}',
    serverSide: true,
    processing: true,
    columns: [
        { data: 'id', name: 'id'},
        { data: 'nm_hubungan', name: 'nm_hubungan' },
...
$('body').on('click', '[data-delete-id]', function (e) {
  ...
  var id = $(this).attr('data-delete-id');
   swal({
        ...
        $.ajax({
          url: '{{ url("datamaster/hubungan/delete") }}',
          type: 'GET',
          dataType: "json",
          data: { data : id },
