...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Ubah Data Agama</h4>
	</div>
	   ...
	   <div class="container">
            <form action="{{ route('agama.update', $agama) }}" method="post">
                 ...
                 <div class="form-group row {{ $errors->has('nm_agama') ? 'has-danger' : '' }}">
                     ...
                     <div class="col-sm-4">
                        <input type="text" name="nm_agama" class="form-control {{ $errors->has('nm_agama') ? 'form-control-danger' : '' }}" value="{{ $agama->nm_agama or old('nm_agama') }}">
