...
@section('subtitle','Manajemen data master agama, pendidikan dalam kk, pendidikan sedang ditempuh, pekerjaan, hubungan keluarga, golongan darah')

@section('content')
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Daftar Golongan Darah</h4>
	</div>
	<div class="card-block">
	   <a href="{{ route('golongan.create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
	   <div class="table-responsive">
	     <table id="data-table-golongan" class="table table-bordered">
...
var table = $('#data-table-golongan').DataTable({
    ...
    ajax: '{{ url("datamaster/golongan") }}',
    serverSide: true,
    processing: true,
    columns: [
        { data: 'id', name: 'id'},
        { data: 'nm_golongan', name: 'nm_golongan' },
...
$('body').on('click', '[data-delete-id]', function (e) {
  ...
  var id = $(this).attr('data-delete-id');
   swal({
        ...
        $.ajax({
          url: '{{ url("datamaster/golongan/delete") }}',
          type: 'GET',
          dataType: "json",
          data: { data : id },
