...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Entry Data Golongan Darah</h4>
	</div>
	   ...
	   <div class="container">
            <form action="{{ route('golongan.store') }}" method="post">
                 ...
                 <div class="form-group row {{ $errors->has('nm_golongan') ? 'has-danger' : '' }}">
                     ...
                     <div class="col-sm-4">
                        <input type="text" name="nm_golongan" class="form-control {{ $errors->has('nm_golongan') ? 'form-control-danger' : '' }}" value="{{ old('nm_golongan') }}">
