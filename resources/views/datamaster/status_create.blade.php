...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Entry Data Status Kawin</h4>
	</div>
	   ...
	   <div class="container">
            <form action="{{ route('status.store') }}" method="post">
                 ...
                 <div class="form-group row {{ $errors->has('nm_status_kawin') ? 'has-danger' : '' }}">
                     ...
                     <div class="col-sm-4">
                        <input type="text" name="nm_status_kawin" class="form-control {{ $errors->has('nm_status_kawin') ? 'form-control-danger' : '' }}" value="{{ old('nm_status_kawin') }}">
