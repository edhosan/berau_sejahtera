...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Daftar Status Kawin</h4>
	</div>
	<div class="card-block">
	   <a href="{{ route('status.create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
	   <div class="table-responsive">
	     <table id="data-table-status" class="table table-bordered">
...
var table = $('#data-table-status').DataTable({
    autoWidth: false,
    responsive: true,
    lengthMenu: [[15, 30, 45, -1], ['15 Rows', '30 Rows', '45 Rows', 'Everything']],
    ajax: '{{ url("datamaster/status") }}',
    serverSide: true,
    processing: true,
    columns: [
        { data: 'id', name: 'id'},
        { data: 'nm_status_kawin', name: 'nm_status_kawin' },
...
$('body').on('click', '[data-delete-id]', function (e) {
  ...
  var id = $(this).attr('data-delete-id');
   swal({
        ...
        $.ajax({
          url: '{{ url("datamaster/status/delete") }}',
          type: 'GET',
          dataType: "json",
          data: { data : id },
