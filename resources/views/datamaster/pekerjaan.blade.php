...
<div class="card">	
	...
	<div class="card-block">
	   <a href="{{ route('pekerjaan.create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
	   <div class="table-responsive">
	     <table id="data-table-pekerjaan" class="table table-bordered">
...
var table = $('#data-table-pekerjaan').DataTable({
    autoWidth: false,
    responsive: true,
    lengthMenu: [[15, 30, 45, -1], ['15 Rows', '30 Rows', '45 Rows', 'Everything']],
    ajax: '{{ url("datamaster/pekerjaan") }}',
    serverSide: true,
    processing: true,
    columns: [
        { data: 'id', name: 'id'},
        { data: 'nm_pekerjaan', name: 'nm_pekerjaan' },
...
$('body').on('click', '[data-delete-id]', function (e) {
  ...
  var id = $(this).attr('data-delete-id');
   swal({
        ...
        $.ajax({
          url: '{{ url("datamaster/pekerjaan/delete") }}',
          type: 'GET',
          dataType: "json",
          data: { data : id },
