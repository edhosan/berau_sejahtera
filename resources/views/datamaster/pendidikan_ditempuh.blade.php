...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Daftar Pendidikan sedang ditempuh</h4>
	</div>
	<div class="card-block">
	   <a href="{{ route('pendidikan_ditempuh.create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
	   <div class="table-responsive">
	     <table id="data-table-pendidikan_ditempuh" class="table table-bordered">
	       <thead class="thead-default">
	           <tr>
	               <th>ID</th>
	               <th>PENDIDIKAN SEDANG DI TEMPUH</th>
	               <th>TGL.DIBUAT</th>
	               <th>TGL.DIUBAH</th>
	               <th>ACTION</th>
	           </tr>
...
var table = $('#data-table-pendidikan_ditempuh').DataTable({
    autoWidth: false,
    responsive: true,
    lengthMenu: [[15, 30, 45, -1], ['15 Rows', '30 Rows', '45 Rows', 'Everything']],
    ajax: '{{ url("datamaster/pendidikan_ditempuh") }}',
    serverSide: true,
    processing: true,
    columns: [
        { data: 'id', name: 'id'},
        { data: 'nm_pendidikan_ditempuh', name: 'nm_pendidikan_ditempuh' },
...
$('body').on('click', '[data-delete-id]', function (e) {
  ...
  var id = $(this).attr('data-delete-id');
   swal({
        ...
        $.ajax({
          url: '{{ url("datamaster/pendidikan_ditempuh/delete") }}',
          type: 'GET',
          dataType: "json",
          data: { data : id },
