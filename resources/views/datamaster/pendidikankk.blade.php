...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Daftar Pendidikan dalam KK</h4>
	</div>
	<div class="card-block">
	   <a href="{{ route('pendidikankk.create') }}" class="btn btn-primary waves-effect">Tambah Data</a>
	   <div class="table-responsive">
	     <table id="data-table-pendidikankk" class="table table-bordered">
...
var table = $('#data-table-pendidikankk').DataTable({
    autoWidth: false,
    responsive: true,
    lengthMenu: [[15, 30, 45, -1], ['15 Rows', '30 Rows', '45 Rows', 'Everything']],
    ajax: '{{ url("datamaster/pendidikankk") }}',
    serverSide: true,
    processing: true,
    columns: [
        { data: 'id', name: 'id'},
        { data: 'nm_pendidikan_kk', name: 'nm_agama' },
...
$('body').on('click', '[data-delete-id]', function (e) {
  ...
  var id = $(this).attr('data-delete-id');
   swal({
        ...
        $.ajax({
          url: '{{ url("datamaster/pendidikankk/delete") }}',
          type: 'GET',
          dataType: "json",
          data: { data : id },
