...
<div class="card">	
	<div class="card-header">  
		<h4 class="card-title">Ubah Data Hubungan Keluarga</h4>
	</div>
	<div class="card-block">
	   <div class="container">
            <form action="{{ route('hubungan.update', $hubungan) }}" method="post">
                 {{ csrf_field() }}
                 ...
                 <div class="form-group row {{ $errors->has('nm_hubungan') ? 'has-danger' : '' }}">
                     ...
                     <div class="col-sm-4">
                        <input type="text" name="nm_hubungan" class="form-control {{ $errors->has('nm_hubungan') ? 'form-control-danger' : '' }}" value="{{ $hubungan->nm_hubungan or old('nm_hubungan') }}">
